...
BEGIN
    ...
    BEGIN
        RAISERROR('La fecha de nacimiento es inv�lida. Debe ser mayor de 18 a�os.',16,1);
        RETURN;
    END;
...
BEGIN
    ...
    BEGIN
        RAISERROR('Ya existe un t�tulo con ese nombre.',16,1);
        RETURN;
    END
...
BEGIN
    ...
    BEGIN
        RAISERROR('No se puede eliminar el titulo porque est� asignado a uno o m�s guias.',16,1);
        RETURN;
    END;
...
BEGIN
    ...
    BEGIN
        RAISERROR('No se puede eliminar la especialidad porque est� asignada a uno o m�s guias.',16,1);
        RETURN;
    END;
...
BEGIN
    ...
    BEGIN
        RAISERROR('La habilitaci�n no existe.',16,1);
        RETURN;
    END;
...
BEGIN
    ...
    BEGIN
        RAISERROR('No se puede eliminar la habilitaci�n porque est� asociada a guias.',16,1);
        RETURN;
    END;
...
BEGIN
    ...
    BEGIN
        RAISERROR('La habilitaci�n del gu�a no existe.',16,1);
        RETURN;
    END;
